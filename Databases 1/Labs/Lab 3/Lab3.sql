TAnum-- Clean up from any previous tutorial actions.
...
SELECT FIRST_NAME AS FIRSTNAME, LAST_NAME AS LASTNAME FROM BORROWER;
SELECT TRANSATIONID, BORROWERID, BOOKID, TRANSACTION_DATE FROM TRANSATION_TYPE WHERE TRANSACTION;
