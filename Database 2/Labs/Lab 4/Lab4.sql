...
grant select on stage to builder2;
grant update (studentname) on student to builder2;

Select studentname, stage_code from TKILLEEN.student for update;
Select studentname, stage_code from TKILLEEN.student for where studentname
like ‘Carol Britton’
for update;

UPDATE TKILLEEN.student
SET studentname = 'Paul Bloggs'
WHERE studentname like 'Thomas Hackett';

commit;

GRANT UPDATE CHACKETT on student to TKILLEEN.student; 